...
int catalog(string code[], int n, string target)
{
    int low = 0;
    int high = n - 1;
...
int catalog(string code[], int low, int high, string target)
{
    if(low > high)
    {
        return -1;
...
int main()
{
    ...
    int result1 =catalog(code, n, target); // iteration
    ...
    int result2 = catalog(code, 0, n - 1, target); // recursion
